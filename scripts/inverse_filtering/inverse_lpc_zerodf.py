...
def inverse_lpc_zerodf(x,dat):
    ...
    for glottal_lpc,glottal_g,lpc_coef,g in zip(glottal_lpcs,glottal_gains,lpcs,gains):
        ...
        recons_psd = lpc.lpc2psd(glottal_lpc,1,fft_size)
        recons_vt_psd = lpc.lpc2psd(lpc_coef,1,fft_size)
    ...
    return  x_res_zerodf,x_glottal_res_zerodf,recons_psds,recons_vt_psds
...
x_res,x_glottal_res,recons_psds,recons_vt_psds = inverse_lpc_zerodf(x,dat)
